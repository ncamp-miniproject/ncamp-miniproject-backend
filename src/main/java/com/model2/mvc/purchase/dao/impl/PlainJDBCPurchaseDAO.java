...
@Deprecated
public class PlainJDBCPurchaseDAO extends DAOTemplate implements PurchaseDAO {
    private static final PlainJDBCPurchaseDAO instance = new PlainJDBCPurchaseDAO();

    private PlainJDBCPurchaseDAO() {
    }

    public static PlainJDBCPurchaseDAO getInstance() {
        return instance;
    }
...
//                                                                            .build(), rs.getInt("quantity")));
    ...
    public boolean insertPurchase(Purchase data) {
    ...
    public boolean updatePurchase(Purchase data) {
    ...
    public boolean updateTranCode(Purchase data) {

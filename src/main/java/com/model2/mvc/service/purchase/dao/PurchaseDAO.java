...
public class PurchaseDAO extends DAOTemplate {
    ...
    private Purchase generateVO(ResultSet rs) throws SQLException {
        ...
        purchaseVO.setPurchaseProd(Product.builder()
    ...
    public void insertPurchase(Purchase data) {
        ...
        update(sql, stmt -> {
            stmt.setInt(1, data.getPurchaseProd().getProdNo());
            ...
            stmt.setString(8, data.getTranCode());
    ...
    public void updateTranCode(Purchase data) {
        ...
        update(sql, stmt -> {
            stmt.setString(1, data.getTranCode());
            stmt.setInt(2, data.getTranNo());
            stmt.setInt(3, data.getPurchaseProd().getProdNo());
        });
    }
}
